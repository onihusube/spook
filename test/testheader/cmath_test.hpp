...
namespace spook_test::complex {

	TEST_CASE("polar test") {
		using namespace spook::literals;

		constexpr double eps = 1.0E-15;

		{
			auto expected = std::polar(1.0, 0.0_rad);
			constexpr auto calc = spook::polar(1.0, 0.0_rad);

			CHECK_EQ(doctest::Approx(expected.real()).epsilon(eps), calc.real());
			CHECK_EQ(doctest::Approx(expected.imag()).epsilon(eps), calc.imag());
		}

		{
			auto expected = std::polar(1.0, 45.0_rad);
			constexpr auto calc = spook::polar(1.0, 45.0_rad);
		...
		{
			auto expected = std::polar(1.0, 90.0_rad);
			constexpr auto calc = spook::polar(1.0, 90.0_rad);
		...
		{
			auto expected = std::polar(1.0, 135.0_rad);
			constexpr auto calc = spook::polar(1.0, 135.0_rad);
		...
		{
			auto expected = std::polar(1.0, 180.0_rad);
			constexpr auto calc = spook::polar(1.0, 180.0_rad);
		...
		{
			auto expected = std::polar(1.0, 225.0_rad);
			constexpr auto calc = spook::polar(1.0, 225.0_rad);
		...
		{
			auto expected = std::polar(1.0, 270.0_rad);
			constexpr auto calc = spook::polar(1.0, 270.0_rad);
		...
		{
			auto expected = std::polar(1.0, 315.0_rad);
			constexpr auto calc = spook::polar(1.0, 315.0_rad);
		...
		{
			auto expected = std::polar(1.0, 360.0_rad);
			constexpr auto calc = spook::polar(1.0, 360.0_rad);
